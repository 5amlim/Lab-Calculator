(() => {
  ...
  function renderTestsOverview(tests) {
    ...
    if (!tests.length) {
      ...
      els.testsOverviewList.innerHTML = '<div class="empty-symbol" aria-hidden="true">＋</div><strong>No tests selected</strong><p>Select Add next to a test to include it here.</p>';
      return;
    }
